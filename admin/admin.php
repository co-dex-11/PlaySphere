...
<div id="users-section" class="section">
    ...
    <div class="create-staff-toggle">
        <button id="toggle-staff-form" class="btn left-aligned">Add Futsal Servior</button>
    </div>

    <!-- Create New Staff User -->
    <div id="create-staff-form" class="create-staff-form" style="display: none;">
        <h2>Create New Futsal Servior</h2>
        <form action="admin.php" method="post">
            ...
            <button type="submit" name="create_staff" class="btn">Create Futsal Servior</button>
        </form>
    </div>
        ...
        <tbody id="user-table-body">
            <?php foreach ($users as $user): ?>
                <tr>
                    ...
                    <td><?= htmlspecialchars(($user['role'] === 'status' || $user['role'] === 'staff') ? 'Futsal Servior' : ucfirst($user['role'])) ?></td>
            ...
            <tbody>
                <?php foreach ($futsals as $futsal): ?>
                    <tr>
                        ...
                        <td>$<?= htmlspecialchars(number_format($futsal['price_per_hour'], 2)) ?></td>
